  ...
  return (
    <main>
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-secondary">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-md">
            Shop clothing built around your dog’s breed and measurements.
          </p>
          <button
            onClick={() => navigate("shop")}
            className="mt-8 flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground font-bold"
          >
      ...
      <section className="bg-card border-y border-border py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 gap-8">
          <Feature
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Available styles from the PawFit catalogue.
            </p>
          </div>
          <button
            onClick={() => navigate("shop")}
